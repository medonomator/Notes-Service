...
export const SECRET_KEY = process.env.SECRET_KEY || 'NeverShareYourSecretKey';
export const PG_URI = process.env.PG_URI || 'postgres://postgres:example@localhost:5432/postgres';
